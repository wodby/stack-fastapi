# FastAPI stack for Wodby

Deploy FastAPI on Kubernetes with Wodby. This repository contains the stack
manifests used by the public FastAPI stack in the Wodby catalog.
